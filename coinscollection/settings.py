...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(ROOT_PATH, 'db', 'coins.db'),
    }
}

FIXTURE_DIRS = (
    os.path.join(ROOT_PATH, 'coins', 'fixtures'),
)
...
STATIC_ROOT = os.path.join(ROOT_PATH, 'content', 'static')
...
SECRET_KEY = 'u6peshuutu$_96l%s&amp;yrge7ks@*6z_z_z&amp;wvkc0iynp#ff4#cy'
