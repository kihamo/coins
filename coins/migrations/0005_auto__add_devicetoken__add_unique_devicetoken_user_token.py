...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'coins_devicetoken', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('token', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'coins', ['DeviceToken'])

        # Adding unique constraint on 'DeviceToken', fields ['user', 'token']
        db.create_unique(u'coins_devicetoken', ['user_id', 'token'])


    def backwards(self, orm):
        # Removing unique constraint on 'DeviceToken', fields ['user', 'token']
        db.delete_unique(u'coins_devicetoken', ['user_id', 'token'])

        # Deleting model 'DeviceToken'
        db.delete_table(u'coins_devicetoken')
