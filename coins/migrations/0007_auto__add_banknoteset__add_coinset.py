...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BanknoteSet'
        db.create_table('coins_banknote_sets', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('image', self.gf('coins.utils.fields.CoinImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'coins', ['BanknoteSet'])

        # Adding model 'CoinSet'
        db.create_table('coins_coin_sets', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('image', self.gf('coins.utils.fields.CoinImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'coins', ['CoinSet'])

        # Adding M2M table for field sets on 'CoinIssue'
        m2m_table_name = db.shorten_name('coins_coin_issues_sets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('coinissue', models.ForeignKey(orm[u'coins.coinissue'], null=False)),
            ('coinset', models.ForeignKey(orm[u'coins.coinset'], null=False))
        ))
        db.create_unique(m2m_table_name, ['coinissue_id', 'coinset_id'])

        # Adding M2M table for field sets on 'BanknoteIssue'
        m2m_table_name = db.shorten_name('coins_banknote_issues_sets')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('banknoteissue', models.ForeignKey(orm[u'coins.banknoteissue'], null=False)),
            ('banknoteset', models.ForeignKey(orm[u'coins.banknoteset'], null=False))
        ))
        db.create_unique(m2m_table_name, ['banknoteissue_id', 'banknoteset_id'])


    def backwards(self, orm):
        # Deleting model 'BanknoteSet'
        db.delete_table('coins_banknote_sets')

        # Deleting model 'CoinSet'
        db.delete_table('coins_coin_sets')

        # Removing M2M table for field sets on 'CoinIssue'
        db.delete_table(db.shorten_name('coins_coin_issues_sets'))

        # Removing M2M table for field sets on 'BanknoteIssue'
        db.delete_table(db.shorten_name('coins_banknote_issues_sets'))
    ...
    models = {
        ...
        u'coins.banknote': {
            ...
            'booked': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'packaged': ('django.db.models.fields.BooleanField', [], {}),
        ...
        u'coins.banknoteissue': {
            ...
            'sets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['coins.BanknoteSet']", 'null': 'True', 'blank': 'True'}),
        ...
        u'coins.banknoteset': {
            'Meta': {'object_name': 'BanknoteSet', 'db_table': "'coins_banknote_sets'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('coins.utils.fields.CoinImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        u'coins.coinissue': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'nominal': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '2'}),
            'painter': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'sculptor': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'series': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['coins.Series']", 'null': 'True', 'blank': 'True'}),
            'sets': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['coins.CoinSet']", 'null': 'True', 'blank': 'True'}),
        ...
        u'coins.coinset': {
            'Meta': {'object_name': 'CoinSet', 'db_table': "'coins_coin_sets'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('coins.utils.fields.CoinImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'})
        ...
        u'coins.devicetoken': {
            'Meta': {'unique_together': "(('user', 'token'),)", 'object_name': 'DeviceToken'},
