...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CoinIssue.painter'
        db.add_column('coins_coin_issues', 'painter',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CoinIssue.sculptor'
        db.add_column('coins_coin_issues', 'sculptor',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CoinIssue.painter'
        db.delete_column('coins_coin_issues', 'painter')

        # Deleting field 'CoinIssue.sculptor'
        db.delete_column('coins_coin_issues', 'sculptor')
    ...
    models = {
        ...
        u'coins.banknote': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'default': '[<Collection: \xd0\xb4\xd0\xb5\xd1\x84\xd0\xbe\xd0\xbb\xd1\x82\xd0\xbd\xd0\xb0\xd1\x8f>]', 'to': u"orm['coins.Collection']"}),
